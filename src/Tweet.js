...
export class Tweet extends Component {
  render() {
    ...
    let state = Math.abs(((now.getMonth() - wasDate.getMonth())) + (now.getYear() - wasDate.getYear()) + Math.abs((now.getDay() - wasDate.getDay())));
    let display_date;
    let withinDay = (now.getDay() - wasDate.getDay());
    ...
    var textUrl;
    var subString = "http";
    var text = tweetData[this.props.i]['text'];
